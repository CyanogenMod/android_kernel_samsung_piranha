...
static void __init syscontrol_setup_regs(void)
{
	...
	/* Disable TShut functionality of thermal protection. instead,
	   reboot system if that case.
	*/
	v = omap4_ctrl_wk_pad_readl(\
		OMAP4_CTRL_MODULE_PAD_WKUP_WKUP_CONTROL_SPARE_RW);
	v &= ~ OMAP4_HW_TSHUT_MASK;
	omap4_ctrl_wk_pad_writel(v,
		OMAP4_CTRL_MODULE_PAD_WKUP_WKUP_CONTROL_SPARE_RW);
